 ...
 */
public class Chapter09_Solutions {
    ...
    public static int[] letterHist(String s) {
        ...
        for(char ch:chars) {
            ...
            if(index > -1) hist[index]++;	
        }
        return hist;
    }

    /**
     * 9.3.1 Returns 0 if the string has the same number of open and close parentheses.
     */
    ...
    public static boolean canSpell(String letters, String word) {
        ...
        for(int i = 0; i < lettersHist.length; i++) {
            if(wordHist[i] > lettersHist[i]) return false;
        }
        return true;
    }
